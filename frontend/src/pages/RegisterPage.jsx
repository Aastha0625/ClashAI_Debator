    ...
    <div className="bg-[#131318] min-h-screen flex items-center justify-center p-4">
      <div className="glass-panel w-full max-w-md p-8 rounded-2xl border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
        <div className="text-center mb-8">
          <h1 className="font-display-lg text-3xl font-black text-white mb-2 uppercase">New User</h1>
          <p className="text-[#b9cacb] font-data-mono text-sm uppercase tracking-widest">Register your identity</p>
        </div>
